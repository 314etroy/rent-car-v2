        ...
        <div class="mx-auto max-w-7xl px-4 bg-[#161321] flex justify-center">
            <div class="py-9">
                <div class="text-center text-white md:text-3xl text-xl font-semibold my-5"
                    style="background-image: url(assets/img/png/optimizat.webp); width: 100%; background-size:cover; background-position:center; align-items:center; display:flex; justify-content:center; color:white;">
