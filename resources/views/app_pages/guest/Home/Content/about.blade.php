            ...
            <div class="transition-all" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
                ...
                <div class="border border-[#27213b] p-[24px] rounded-lg">
                    <div class="box-border flex justify-between max-[400px]:block">
                        <div class="left">
                            <div class="name">
                                <span class="text-white text-[16px] leading-[28px] font-bold">Nume complet
                                    :</span><br>
                                <span class="detail text-[14px] leading-[28px] text-[#777]">Bogdan Dudu</span>
                            </div>
                            <div class="age pt-[20px]">
                                <span class="text-white text-[16px] leading-[28px] font-bold">An infiinatre :</span><br>
                        ...
                        <div class="right">
                            <div class="ph">
                                ...
                                <span class="detail text-[14px] leading-[28px] text-[#777]">+40 0775123456</span>
                            </div>
