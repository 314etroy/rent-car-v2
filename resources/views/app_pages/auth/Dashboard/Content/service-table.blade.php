    ...
    <div class="relative overflow-x-auto">
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    @foreach (tableHead($tableData, ['Id'], ['Action']) ?? [] as $value)
        ...
        @include('common.generic-modal', [
            ...
            'btn_collor' => 'blue',
            'canBeClosed' => true,
            'modal_fields' => modifArray($inputs, ['key' => '-edit']),
        ])
...
<script>
    ...
    const getId = (id) => {
        ...
        // Seteaza valoarea row-ului
        let rowId = document.getElementById('edit_row_id')
        ...
        Object.keys(data).forEach(function(key) {
            ...
            const labelId = key + '-edit-label';

            const labelElement = document.getElementById(labelId);

            if (labelElement) {
                labelElement.value = value;
                labelElement.setAttribute("wire:model.live", "rawData.service." + id + "." + key);
            } else {
