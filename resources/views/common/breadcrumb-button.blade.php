@props([
    ...
    'activeCss' =>
        'inline-flex items-center text-sm font-medium hover:text-gray-900 dark:text-gray-400 dark:hover:text-white rounded-[1rem] bg-[#7963e0] px-2 py-0.5 text-white',
])
